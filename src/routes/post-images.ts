...
import {cleanupUpload, fileUpload, validate} from '@/middlewares';
...
postImagesRouter.post(Routes.postImage, fileUpload(ImagesStorageDir).single('image'), createPostImage, cleanupUpload);
